...
function(target_install_resources target)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/data")
    ...
    install(DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/data/" DESTINATION "${target}/data/${PLUGIN_NAME}" USE_SOURCE_PERMISSIONS)
...
function(target_add_resource target resource)
  ...
  install(FILES "${resource}" DESTINATION "${target}/data/${PLUGIN_NAME}" COMPONENT Runtime)
